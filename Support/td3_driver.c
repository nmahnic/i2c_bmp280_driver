...
#define     CM_PER_I2C1     0x48     // I2C1 0x48 // I2C2 0x44

// Defines del modulo de control
#define     CTRL_MOD        0x44E10000      // Base del modulo de control
#define     CM_I2C1_SDA     0x95C    // I2C1 0x95C // I2C2 0x978
#define     CM_I2C1_SCL     0x958    // I2C1 0x958 // I2C2 0x97C

// L4_PER
//Defines del modulo de registro
#define     RM_I2C1         0x4802A000 // I2C1 0x4802A000  // I2C2 0x4819C000  
...
ssize_t i2c_read (struct file *file, char __user *userbuff, size_t tamano, loff_t *offset){
    ...
    //printk(KERN_WARNING "Driver I2C: READ abierto");
    ...
    iowrite32(0x77, remapI2C_reg+I2C_SA);
    ...
    {
        printk(KERN_NOTICE "-----------------------------------------\n");
        printk(KERN_NOTICE "Driver I2C: ERROR en la lectura\n");
        printk(KERN_NOTICE "-----------------------------------------\n");
    }
...
static int __init i2c_init(void) {
    ...
    alloc_chrdev_region (&myDevice, first_minor, minor_numbers, "I2C_TD3_Driver"); 
